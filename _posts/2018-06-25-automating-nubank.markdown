...
Casa rota aponta para um endereço de um proxy `https://prod-s0-webapp-proxy.nubank.com.br`, seguido de uma URI, no caso de login `/api/proxy/AJxL5L2Tx4PB-W6VD1S2xp14EDQ.aHR0cHM6Ly9wcm9kLWdsb2JhbC1hdXRoLm51YmFuay5jb20uYnIvYXBpL3Rva2Vu`.
